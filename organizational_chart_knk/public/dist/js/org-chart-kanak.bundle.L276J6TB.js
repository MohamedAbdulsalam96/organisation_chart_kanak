(() => {
  ...
  // ../organizational_chart_knk/organizational_chart_knk/public/js/hierarchy_chart.js
  ...
  hrms.OrgChartKnk = class {
    ...
    export_chart() {
      ...
      (0, import_html2canvas.default)(document.querySelector("#orgchart_kanak_main"), {
    ...
    makeOrgChart(data) {
      ...
      this.chart = new d3.OrgChart().nodeHeight((d) => 100 + 25).nodeWidth((d) => 220 + 2).childrenMargin((d) => 50).compactMarginBetween((d) => 35).compactMarginPair((d) => 30).neighbourMargin((a, b) => 20).nodeContent(function(d, i, arr, state) {
        const color = "#FFFFFF";
        ...
        return `
	                ...
	                `;
      }).container(elmt).data(data).render();
...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
//# sourceMappingURL=org-chart-kanak.bundle.L276J6TB.js.map
