(() => {
  ...
  // ../organisation_chart_kanak/organisation_chart_kanak/public/js/hierarchy_chart/hierarchy_chart_desktop.js
  ...
  erpnext.HierarchyChart = class {
    ...
    get_connector(pos_parent_right, pos_child_left) {
      if (pos_parent_right.y === pos_child_left.y) {
        ...
        return "M" + pos_parent_right.x + "," + pos_parent_right.y + " L" + pos_parent_right.x + "," + pos_parent_right.y + " " + arc_1 + "L" + (pos_parent_right.x + 50) + "," + (pos_child_left.y + offset) + " " + arc_2 + "L" + pos_child_left.x + "," + pos_child_left.y;
      }
    }
  ...
  // ../organisation_chart_kanak/organisation_chart_kanak/public/js/hierarchy_chart/hierarchy_chart_mobile.js
  ...
  // frappe-html:/Users/kanak/frapee15_2/frappe-bench/apps/organisation_chart_kanak/organisation_chart_kanak/public/js/templates/node_card.html
...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
//# sourceMappingURL=hierarchy-chart.bundle.7UUPOUBO.js.map
